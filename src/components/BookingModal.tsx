...
const ADDONS = [
  { id: "linen hire + laundry services(2bedrooms)", label: "Hire, laundry, collection and drop off included", price: 50 },
  { id: "linen hire + laundry services(3bedrooms)", label: "Hire, laundry, collection and drop off included", price: 75 },
