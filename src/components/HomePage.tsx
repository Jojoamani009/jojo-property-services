...
const services = [
  ...
  { icon: Building2,    label: "End of Tenancy Clean",  desc: "Guaranteed deposit-back end of tenancy/one-off deep clean",                                                                       from: "£140"      },
  ...
  { icon: Sparkles,     label: "Commercial Clean",      desc: "Regular, flexible offices and retail property clean. Other Services includes: Carpet & Upholstery deep clean & Oven Deep Clean", from: "£25/hr"    },
  ...
  { icon: Armchair,     label: "Sofa Deep Clean",       desc: "Professional upholstery & sofa cleaning",                                                                                        from: "£30/seat"  },
];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Jojo Property Services Ltd",
            "image": "https://jojopropertyservices.co.uk/logo.jpg",
            "telephone": "07305851573",
            "email": "info@jojopropertyservices.co.uk",
            "address": {
              "@type": "PostalAddress",
            ...
            "areaServed": ["Peterborough", "Wisbech", "March", "Market Deeping", "Bourne", "Stamford", "Whittlesey"],
            "serviceType": [
              "Domestic Cleaning",
              "Commercial Cleaning",
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif", color: "#1a1a2e", background: "#fff" }}>
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .section-title { font-family: 'Playfair Display', serif; font-size: 38px; font-weight: 700; line-height: 1.2; color: #0d1b3e; }
            ...
            <div style={{ background: "#fff", borderRadius: 20, padding: 32, boxShadow: "0 8px 40px rgba(26,107,255,0.10)", border: "1px solid #eef1f8" }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <select value={formData.service} name="service" onChange={handleChange}
                  ...
                  <option value="sofa">Sofa Deep Clean — £30/seat</option>
                </select>
              </div>
              ...
              {["domestic", "commercial", "tenancy", "carpet", "oven", "sofa"].includes(formData.service) && (
                    ...
                    <div>
                      <div style={{ fontSize: 40, fontWeight: 800, color: "#1a6bff", lineHeight: 1 }}>
                        £{
                          ...
                          formData.service === "oven" ? 70 :
                          formData.service === "sofa" ? 30 : 0
                        }
                      </div>
                      <div style={{ fontSize: 13, color: "#8a96b0", marginTop: 4 }}>
                        ...
                        {formData.service === "sofa" && "per seat"}
                      </div>
                    </div>
        ...
        <section className="section" id="services">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              ...
              <p className="section-sub" style={{ maxWidth: 500, margin: "12px auto 0" }}>Comprehensive cleaning and property services, all under one roof.</p>
            </div>
              ...
              {reviews.map(({ name, loc, stars, text }) => (
                <div key={name} style={{ background: "#fff", border: "1.5px solid #eef1f8", borderRadius: 16, padding: 28 }}>
                  <div style={{ display: "flex", gap: 3, marginBottom: 14 }}>
                    {Array.from({ length: stars }).map((_, i) => <Star key={i} size={16} fill="#facc15" color="#facc15" />)}
                  </div>
        ...
        <section style={{ background: "linear-gradient(135deg, #1a6bff 0%, #0f4ac4 100%)", padding: "64px 0" }}>
          <div className="container" style={{ textAlign: "center" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 40, fontWeight: 700, color: "#fff" }}>Ready to Transform Your Property?</h2>
            ...
            <div style={{ display: "flex", gap: 14, justifyContent: "center", marginTop: 28, flexWrap: "wrap" }}>
              <a href="#contact" style={{ background: "#fff", color: "#1a6bff", padding: "14px 30px", borderRadius: 8, fontWeight: 700, fontSize: 15, textDecoration: "none" }}>Get Free Quote</a>
            ...
            <div style={{ background: "#fff", border: "1.5px solid #eef1f8", borderRadius: 20, padding: 36 }}>
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  <input name="postcode" placeholder="Postcode" value={formData.postcode} onChange={handleChange} />
          ...
          <div className="container">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
              ...
              <div style={{ display: "flex", gap: 20 }}>
                <a href="/about" style={{ fontSize: 13, color: "#8a96b0", textDecoration: "none" }}>About Us</a>
                <a href="/privacy-policy" style={{ fontSize: 13, color: "#8a96b0", textDecoration: "none" }}>Privacy Policy</a>
              </div>
